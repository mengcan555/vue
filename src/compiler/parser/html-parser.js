...
const ncname = `[a-zA-Z_][\\-\\.0-9_a-zA-Z${unicodeRegExp.source}]*` // 返回正则表达式的文本内容，不包括标志, 比如/g等
...
export function parseHTML (html, options) {
  ...
  function parseEndTag (tagName, start, end) {
    ...
    } else if (lowerCasedTagName === 'br') { // <br> <br /> 没有闭合标签
      if (options.start) {
